...
import com.sleephelper.service.AuraLinkPoints2Service;
...
@Slf4j
@Service
public class AuraLinkPoints2ServiceImpl implements AuraLinkPoints2Service {
    ...
    public AuraLinkPoints2ServiceImpl() {
        // 延迟初始化，等待配置注入
    }
